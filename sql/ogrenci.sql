...
CREATE TABLE `ogrenci` (
  ...
  `okuladi` varchar(45) NOT NULL,
  KEY `ogrenci_ibfk_1` (`p_id`),
  CONSTRAINT `ogrenci_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `kullanicilar` (`id`)
...
INSERT INTO `ogrenci` VALUES (60,5656,'sdada'),(61,5656,'fdfdf');
